...
func (a *App) drawSplash() {
	...
	box(11, dos.Attr(dos.White, dos.Black), "v1.10   ::   war-dialing the IPv4 phone book")
	box(13, dos.Attr(dos.LightGray, dos.Black), "a port of ToneLoc by Minor Threat & Mucho Maas  ::  1994")
	box(14, dos.Attr(dos.LightGray, dos.Black), "scanner powered by zmap-go")
